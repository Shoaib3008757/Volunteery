...
ProgressBar bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mangecompanylist);
    ...
    private class AsyncDataClass extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("") || result == null) {
                ...
                Toast.makeText(ManageActivities.this, "Server connection failed",
            ...
            if (tagCompany==2){
                ...
                if(result.equals("company deleted successfully")){
                    Toast.makeText(ManageActivities.this, "company deleted successfully" , Toast.LENGTH_SHORT).show();

                    Intent startAgain = new Intent(ManageActivities.this, ManageCompanies.class);
    ...
    protected void showList(String result) {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ManageActivities.this, jobList, R.layout.list_layout_mange_company,
    ...
    public void listViewItemClickLister(){
        ...
        list_view_report.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final Dialog deleteDialog = new Dialog(ManageActivities.this);
...
//
                ...
                activities.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent viewCompanyActivities = new Intent(ManageActivities.this, AdminViewCompanyActivities.class);
  ...
  /*  @Override
    public void onBackPressed() {
        ...
        finish();
        Intent i = new Intent(ManageActivities.this, ViewJobs.class);
        startActivity(i);
    }*/
