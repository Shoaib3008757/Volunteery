...
public class ViewCompanyList extends AppCompatActivity {
    ProgressBar bar;
    String URLRESULT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_company_list);
    ...
    private class AsyncDataClass extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("") || result == null) {
                ...
                Toast.makeText(ViewCompanyList.this, "Server connection failed",
            ...
            if (tagCompany==2){
                ...
                if(result.equals("company deleted successfully")){
                    Toast.makeText(ViewCompanyList.this, "company deleted successfully" , Toast.LENGTH_SHORT).show();

                    Intent startAgain = new Intent(ViewCompanyList.this, ManageCompanies.class);
    ...
    protected void showList(String result) {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ViewCompanyList.this, jobList, R.layout.list_layout_mange_company,
    ...
    public void listViewItemClickLister(){
        ...
        list_view_report.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                RelativeLayout activities = (RelativeLayout)view.findViewById(R.id.rlviewactivities);


               final String mcompany = listCompanyname.getText().toString();
                ...
                final Dialog deleteDialog = new Dialog(ViewCompanyList.this);
                ...
                dComapnyName.setText("Do you Realy Want To Remove " +"'"+ mcompany + "'");
...
//
                ...
                activities.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Log.e("TAG", "TEST ME "+ mcompany);

                        Intent viewCompanyActivities = new Intent(ViewCompanyList.this, ViewCompanyActivities.class);
                        viewCompanyActivities.putExtra("companyname", mcompany);
                        startActivity(viewCompanyActivities);
                        //Toast.makeText(ViewCompanyList.this, "Text Text Text", Toast.LENGTH_SHORT).show();
                    }
                });

            }
        });
    }//end of listItem Click
    ...
    public void onBackPressed() {
        ...
        finish();
        Intent i = new Intent(ViewCompanyList.this, ViewJobs.class);
        startActivity(i);
    }
